...
import { NextButton, PrevButton, usePrevNextButtons } from '../sliderarrows/sliderarrows'
...
import ModalVideo from '@/components/website/home/our-customers/modal-video/modal-video'
import { CTAGroupLight } from '@/components'
const ThumbSlider = ({ arrows = true }) => {
    ...
    return (
        <div className={styles.embla} ref={emblaRef}>
            ...
            <div className={styles.embla_thumbs}>
                ...
                {arrows && <div className={styles.arrowsRoot}>
